...
#plt.savefig('/sdcard/Ajay/Matrix_assignment/line_assignment/linefig.pdf')
#subprocess.run(shlex.split("termux-open /sdcard/Ajay/Matrix_assignment/line_assignment/linefig.pdf"))
